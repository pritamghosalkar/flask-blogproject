...
If you did not make this request then simply ignore this email and no changes will done.
'''
    mail.send(msg)
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password has been updated, you are ready to log in', 'success')
        return redirect(url_for('login'))
